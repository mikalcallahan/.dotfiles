...
source ~/.dotfiles/colors/nord/nord.sh # pywal scheme
...
#export ICON_COLOR=$CBRIGHT # Color of all icons
export ICON_COLOR=$CGREEN # Color of all icons
# export ICON_COLOR_WARNING=$CYELLOW # Color of all icons
export ICON_COLOR_WARNING=$CYELLOW # Icon warning color
export ICON_COLOR_ALERT=$CBLUE     # Icon alert color
export LABEL_COLOR=$CWHITE         # Color of all labels
